...
// ── projeção operacional para OS (seção 13 — Produção sem financeiro) ──
{
  ...
  // GO-LIVE 2026-08-11, P0 seção 17 — achado real ("vender A, produzir B"):
  // "planificacoes" (o layout de corte/templates SVG) é dado 100% técnico/
  // operacional, nunca financeiro, e antes ficava de fora da projeção —
  // a OS nunca tinha acesso ao layout gráfico do produto vendido.
  test('21. projeção da OS mantém recipeSnapshot com dados operacionais (nome/dim3d/peças/campos/planificacoes — layout de corte)', Object.keys(projecao.recipeSnapshot).sort(), ['campos', 'dim3d', 'nome', 'pecas', 'planificacoes']);
